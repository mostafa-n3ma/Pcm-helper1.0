...
public class CoordinateConversion
{
    ...
    public String latLon2UTM_x(double latitude, double longitude)
    {
        LatLon2UTM c = new LatLon2UTM();
        return c.convertLatLonToUTM_x(latitude, longitude);

    }
    public String latLon2UTM_y(double latitude, double longitude)
    {
        LatLon2UTM c = new LatLon2UTM();
        return c.convertLatLonToUTM_y(latitude, longitude);
    ...
    private class LatLon2UTM
    {
        ...
        public String convertLatLonToUTM_x(double latitude, double longitude)
        {
            validate(latitude, longitude);
            String UTM = "";
        ...
        public String convertLatLonToUTM_y(double latitude, double longitude)
        {
            validate(latitude, longitude);
            String UTM = "";
